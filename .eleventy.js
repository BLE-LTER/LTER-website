// manually written config with the help of tutorials
...
// eleventy config template from https://github.com/danurbanowicz/eleventy-netlify-boilerplate/blob/master/.eleventy.js
...
module.exports = function(eleventyConfig) {
  ...
  return {
    ...
    dir: {
      ...
      data: "", 				// relative to input
      output: "./public/_site" // not relative to input, relative to root 11ty folder
    }
  };
};